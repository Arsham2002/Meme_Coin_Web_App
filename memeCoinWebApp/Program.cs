...
builder.Services.AddDbContext<MvcMessageContext>(options =>
    options.UseSqlite(builder.Configuration.GetConnectionString("MvcMessageContext") ?? throw new InvalidOperationException("Connection string 'MvcMessageContext' not found.")));
